...
class DataFetcherManager:
    ...
    def _init_default_fetchers(self) -> None:
        ...
        print(f"📊 [DataFetcher] Initialized sources: {priority_info}")
    ...
    def get_daily_data(
        ...
        for fetcher in self._fetchers:
            try:
                ...
                print(f"⚠️ [DataFetcher] {fetcher.name} failed for {stock_code}: {e}") # Explicit print for user visibility
        ...
        print(f"❌ [DataFetcher] All sources failed for {stock_code}")
